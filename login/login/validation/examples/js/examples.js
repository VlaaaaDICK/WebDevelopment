...
function initForm1() {
    ...
    formActionHtml += '    <div class="col-sm-6" method="post">';
    formActionHtml += '        <button style="background-color: #00BFFF" type="submit" class="btn btn-block btn-success btn-submit-success" onclick="writeInXml()"><i class="fa fa-check-circle"></i> Submit </button>';
    formActionHtml += '    </div>';
